...
class MyMainApp:
    ...
    def __init__(self, windowobj):
        ...
        # The fill option is set to "BOTH"
        Button(windowobj, text='Left',command=(lambda:sys.stdout.write('Left button pressed\n'))).pack(side=LEFT, fill=BOTH, expand=YES)
        Button(windowobj, text='CLICK HERE TO EXIT',command=(lambda:sys.exit("Program ended normally !!"))).pack(side=LEFT, fill=BOTH, expand=YES)
