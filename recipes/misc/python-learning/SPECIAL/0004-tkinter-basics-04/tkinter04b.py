...
class MyMainApp:
    ...
    def __init__(self, windowobj):
        ...
        # By setting the buttons to "TOP" they will arrenge top-to-bottom
        Button(windowobj, text='Left',command=(lambda:sys.stdout.write('Left button pressed\n'))).pack(side=TOP)
        Button(windowobj, text='CLICK HERE TO EXIT',command=(lambda:sys.exit("Program ended normally !!"))).pack(side=TOP)
